...
- With AI Unit Test Extension, writing unit tests has never been easier—generate, customize, and save your test cases effortlessly! By supporting Gemini, OpenAI and Claude the plugin enables users to compare results from different AI models and choose the best one for their specific use case.

**Important Notes:**
- The default prompt utilizes xUnit and Moq for generating unit tests. However, you have the flexibility to modify both the prompt and the AI models to better suit your requirements.
